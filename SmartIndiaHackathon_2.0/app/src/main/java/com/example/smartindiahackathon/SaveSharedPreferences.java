...
public class SaveSharedPreferences {
    static final String USER_NAME = "username", DEVICE_TOKEN = "myToken", THUBMBNAIL_URL = "myThumbnailUrl", AIRPORT_NAME = "myAirport", USER_EMAIL = "myEmail", USER_PROFILE = "myProfile";
    ...
    public static void setUserEmail(Context ctx, String my_email)
    {
        SharedPreferences.Editor editor = getSharedPreferences(ctx).edit();
    ...
    public static void setUserProfile(Context ctx, String my_profile)
    {
        SharedPreferences.Editor editor = getSharedPreferences(ctx).edit();
        editor.putString(USER_PROFILE, my_profile);
        editor.commit();
    }

    public static String getUserProfile(Context ctx)
    {
        return getSharedPreferences(ctx).getString(USER_PROFILE, "");
    }
