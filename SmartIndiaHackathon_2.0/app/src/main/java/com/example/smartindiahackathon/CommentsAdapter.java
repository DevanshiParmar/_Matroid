...
public class CommentsAdapter extends RecyclerView.Adapter<CommentsAdapter.CommentsViewHolder>{
    ...
    public void onBindViewHolder(final CommentsViewHolder holder, final int position) {
        ...
        if(type.equals("text")){
            ...
            Picasso.with(context).load(c.getThumbnail_image_url()).networkPolicy(NetworkPolicy.OFFLINE).into(holder.profileImage, new Callback() {
                @Override
            ...
            Picasso.with(context).load(c.getComment()).networkPolicy(NetworkPolicy.OFFLINE).into(holder.messageImage, new Callback() {
                @Override
                public void onSuccess() {
